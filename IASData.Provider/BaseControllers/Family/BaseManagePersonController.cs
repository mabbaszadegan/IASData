...
{
    public class BaseManagePersonController : Controller
    {
        ...
        public ActionResult RemoveMember(int id)
        {
            ...
            List<ExpireCause> expireCauses = new List<ExpireCause>
            {
                new ExpireCause { ExpireCauseName = "" }
            };
            expireCauses.AddRange(db.ExpireCauseRepository.Get().OrderBy(q => q.ExpireCauseName));
            ViewBag.ExpireCauseId = new SelectList(expireCauses, "ExpireCauseId", "ExpireCauseName", person.BeliveId);
